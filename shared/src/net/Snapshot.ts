 ...
 */
/** Everything about the room itself, as opposed to the fight going on inside it. */
export interface RoomInfo {
  mapId: string;
  /** A new map after every match, rather than whatever the host last picked. */
  randomize: boolean;
  /** A map change that has been called but not applied yet, and the seconds left on it. */
